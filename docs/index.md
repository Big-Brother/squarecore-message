...
For more information refer to the [squarecore-message](https://github.com/bitpay/squarecore-message) github repo.
...
```bash
npm install squarecore-message --save
```

For client-side projects:

```bash
bower install squarecore-message --save
```
